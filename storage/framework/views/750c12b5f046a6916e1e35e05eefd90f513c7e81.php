    ...
    <div class="sidebar pt-0 mt-0">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.registerMembers2023')); ?>"
                        class="nav-link <?php if(request()->path() == 'admin/registerMembers2023'): ?> active <?php endif; ?>">
                ...
                <?php if(empty($admin->role) || (!empty($permissions) && in_array('Website Customization', $permissions))): ?>
                    <li
                        ...
                        <?php elseif(request()->is('admin/flink/edit/*')): ?> menu-open <?php endif; ?>">
                        <a href="#"
                            class="nav-link
                            ...
                            <?php elseif(request()->is('admin/slinks/edit/*')): ?> active <?php endif; ?>">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.slinks')); ?>"
                                    class="nav-link
                            ...
                            <?php elseif(request()->path() == 'admin/sitemap'): ?>  menu-open <?php endif; ?>">
                                <a href="#"
                                    class="nav-link 
                                <?php if(request()->path() == 'admin/seoinfo'): ?> active 
                                <?php elseif(request()->path() == 'admin/sitemap'): ?>  active <?php endif; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                ...
                                <ul class="nav nav-treeview ">
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo e(route('admin.sitemap.index') . '?language=' . $lang_code); ?>"
                                            class="nav-link 
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.pagevisibility')); ?>"
                                    ...
                                    <?php elseif(request()->path() == 'admin/page-visibility/theme6'): ?> active 
                                    <?php elseif(request()->path() == 'admin/page-visibility/innerpage'): ?> active 
                                    <?php elseif(request()->path() == 'admin/page-visibility/others'): ?> active <?php endif; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.permalinks.index')); ?>"
                                    class="nav-link
                                    <?php if(request()->path() == 'admin/permalinks'): ?> active <?php endif; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.flink.index') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                                <?php if(request()->path() == 'admin/flink'): ?> active 
                                <?php elseif(request()->path() == 'admin/flink/add'): ?> active
                                <?php elseif(request()->is('admin/flink/edit/*')): ?> active <?php endif; ?>
                                ">
                                    <i class="far fa-circle nav-icon"></i>
                ...
                <?php if(empty($admin->role) || (!empty($permissions) && in_array('General Settings', $permissions))): ?>
                    <li
                        ...
                        <?php elseif(request()->is('admin/slinks/edit/*')): ?> menu-open <?php endif; ?>">
                        <a href="#"
                            class="nav-link
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.theme_version')); ?>"
                                    class="nav-link
                            <?php if(request()->path() == 'admin/theme-version'): ?> active <?php endif; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <?php elseif(request()->path() == 'admin/mail-admin'): ?>  menu-open <?php endif; ?>">
                                <a href="#"
                                    class="nav-link 
                                <?php if(request()->path() == 'admin/email-config'): ?> active 
                                <?php elseif(request()->path() == 'admin/mail-admin'): ?>  active <?php endif; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                ...
                                <ul
                                    ...
                                    ">
                                    <li class="nav-item">
                                        <a href="<?php echo e(route('admin.mail.config')); ?>"
                                            class="nav-link 
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo e(route('admin.mailadmin')); ?>"
                                            class="nav-link 
                ...
                <?php if(empty($admin->role) || (!empty($permissions) && in_array('Ecommerce', $permissions))): ?>
                    <li
                        ...
                        <?php elseif(request()->path() == 'admin/currency/add'): ?> menu-open <?php endif; ?>">
                        <a href="#"
                            class="nav-link
                        ...
                        <?php elseif(request()->path() == 'admin/currency/add'): ?> active <?php endif; ?>">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                ...
                                <?php elseif(request()->is('admin/currency/edit/*')): ?> active <?php endif; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                ...
                                <?php elseif(request()->is('admin/payment/gateway/edit/*')): ?> active <?php endif; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.shipping.index') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                                <?php if(request()->path() == 'admin/shipping/methods'): ?> active
                                <?php elseif(request()->is('admin/shipping/method/edit/*')): ?> active <?php endif; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                    ...
                    <li
                        ...
                        <?php elseif(request()->is('admin/product/orders/detais/*')): ?> menu-open <?php endif; ?>">
                        <a href="#"
                            class="nav-link
                            ...
                            <?php elseif(request()->is('admin/product/orders/detais/*')): ?> active <?php endif; ?>">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.product.category') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                                <?php if(request()->path() == 'admin/product/product-category'): ?> active
                                <?php elseif(request()->path() == 'admin/product/product-category/add'): ?> active
                                <?php elseif(request()->is('admin/product/product-category/edit/*')): ?> active <?php endif; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p><?php echo e(__('Product Categories')); ?></p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.product') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                                <?php if(request()->path() == 'admin/product'): ?> active
                                <?php elseif(request()->path() == 'admin/product/add'): ?> active
                                <?php elseif(request()->is('admin/product/edit/*')): ?> active <?php endif; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.processing.product.orders')); ?>"
                                    class="nav-link
                                    <?php if(request()->path() == 'admin/product/processing/orders'): ?> active <?php endif; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.completed.product.orders')); ?>"
                                    class="nav-link
                                    <?php if(request()->path() == 'admin/product/completed/orders'): ?> active <?php endif; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.rejected.product.orders')); ?>"
                                    class="nav-link
                                    <?php if(request()->path() == 'admin/product/rejected/orders'): ?> active <?php endif; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                ...
                <?php if(empty($admin->role) || (!empty($permissions) && in_array('Home', $permissions))): ?>
                    <li
                        ...
                        <?php elseif(request()->is('admin/testimonial/edit/*')): ?> menu-open <?php endif; ?>
                        ">
                        <a href="#"
                            class="nav-link
                        ...
                        <?php elseif(request()->is('admin/testimonial/edit/*')): ?> active <?php endif; ?>
                        ">
                        ...
                        <ul class="nav nav-treeview">
                            <li
                                ...
                                <?php elseif(request()->path() == 'admin/hero/herovideo'): ?> menu-open
                                <?php elseif(request()->path() == 'admin/slider/add'): ?> menu-open
                                <?php elseif(request()->is('admin/slider/edit/*')): ?> menu-open <?php endif; ?>
                                ">
                                <a href="#"
                                    class="nav-link
                                <?php if(request()->path() == 'admin/hero/static'): ?> active
                                ...
                                <?php elseif(request()->path() == 'admin/hero/herovideo'): ?> active
                                <?php elseif(request()->path() == 'admin/slider/add'): ?> active
                                <?php elseif(request()->is('admin/slider/edit/*')): ?> active <?php endif; ?>
                                ">
                                    <i class="far fa-circle nav-icon"></i>
                                ...
                                <ul
                                    ...
                                    ">
                                    <li class="nav-item">
                                        <a href="<?php echo e(route('admin.hero.index') . '?language=' . $lang_code); ?>"
                                            class="nav-link
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo e(route('admin.slider') . '?language=' . $lang_code); ?>"
                                            class="nav-link
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo e(route('admin.herovideo')); ?>"
                                            class="nav-link
                            ...
                            <li
                                class="nav-item 
                                    <?php if(request()->path() == 'admin/ecommerce/slider'): ?> menu-open
                                        ...
                                        <?php elseif(request()->path() == 'admin/ecommerce/banner'): ?> menu-open
                                        <?php elseif(request()->path() == 'admin/ecommerce/banner/add'): ?> menu-open
                                        <?php elseif(request()->is('admin/ecommerce/banner/edit/*')): ?> menu-open <?php endif; ?>
                                ">
                                <a href="#"
                                    class="nav-link
                                        ...
                                        <?php elseif(request()->path() == 'admin/ecommerce/banner'): ?> active
                                        <?php elseif(request()->path() == 'admin/ecommerce/banner/add'): ?> active
                                        <?php elseif(request()->is('admin/ecommerce/banner/edit/*')): ?> active <?php endif; ?>
                                    ">
                                    <i class="far fa-circle nav-icon"></i>
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?php echo e(route('admin.ecommerce.slider') . '?language=' . $lang_code); ?>"
                                            class="nav-link
                                            <?php if(request()->path() == 'admin/ecommerce/slider'): ?> active
                                            <?php elseif(request()->path() == 'admin/ecommerce/slider/add'): ?> active
                                            <?php elseif(request()->is('admin/ecommerce/slider/edit/*')): ?> active <?php endif; ?>
                                        ">
                                            <i class="far fa-dot-circle nav-icon"></i>
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo e(route('admin.ecommerce.banner') . '?language=' . $lang_code); ?>"
                                            class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.about_section') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.w_w_a') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.feature.index') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.intro_video') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.why_chooseus') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.service_section') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.project_section') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.testimonial') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.team') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                            <?php if(request()->path() == 'admin/team'): ?> active
                            <?php elseif(request()->path() == 'admin/team/add'): ?> active
                            <?php elseif(request()->is('admin/team/edit/*')): ?> active <?php endif; ?>
                            ">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.faq') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                            <?php if(request()->path() == 'admin/faq'): ?> active
                            <?php elseif(request()->path() == 'admin/faq/add'): ?> active
                            <?php elseif(request()->is('admin/team/faq/*')): ?> active <?php endif; ?>
                            ">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.counter.index') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                            <?php if(request()->path() == 'admin/counter'): ?> active 
                            <?php elseif(request()->path() == 'admin/counter/add'): ?> active
                            <?php elseif(request()->is('admin/counter/edit/*')): ?> active <?php endif; ?>
                            ">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.meet_section') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.contact_section') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.blog_section') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.client.index') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                            <?php if(request()->path() == 'admin/client'): ?> active 
                            <?php elseif(request()->path() == 'admin/client/add'): ?> active
                            <?php elseif(request()->is('admin/client/edit/*')): ?> active <?php endif; ?>
                            ">
                                    <i class="far fa-circle nav-icon"></i>
                ...
                <?php if(empty($admin->role) || (!empty($permissions) && in_array('Inner Page', $permissions))): ?>
                    <li
                        ...
                        <?php elseif(request()->is('admin/portfolio/edit/*')): ?> menu-open <?php endif; ?>">
                        <a href="#"
                            class="nav-link
                            ...
                            <?php elseif(request()->is('admin/portfolio/edit/*')): ?> active <?php endif; ?>">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.history.index') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                                    <?php if(request()->path() == 'admin/history'): ?> active 
                                    <?php elseif(request()->path() == 'admin/history/add'): ?> active
                                    <?php elseif(request()->is('admin/history/edit/*')): ?> active <?php endif; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p><?php echo e(__('About History')); ?></p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.package') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                                    <?php if(request()->path() == 'admin/package'): ?> active
                                    <?php elseif(request()->path() == 'admin/package/add'): ?> active
                                    <?php elseif(request()->is('admin/package/edit/*')): ?> active <?php endif; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.service') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                                    <?php if(request()->path() == 'admin/service'): ?> active
                                    <?php elseif(request()->path() == 'admin/service/add'): ?> active
                                    <?php elseif(request()->is('admin/service/edit/*')): ?> active <?php endif; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.contact_page') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                                    <?php if(request()->path() == 'admin/contact-page'): ?> active <?php endif; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.portfolio.index') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                ...
                <?php if(empty($admin->role) || (!empty($permissions) && in_array('Quote', $permissions))): ?>
                    <li
                        ...
                        <?php elseif(request()->is('admin/quote/details/*')): ?> menu-open <?php endif; ?>
                        ">
                        <a href="#"
                            class="nav-link <?php if(request()->path() == 'admin/all/quote'): ?> active 
                            ...
                            <?php elseif(request()->is('admin/quote/details/*')): ?> active <?php endif; ?>">
                ...
                <?php if(empty($admin->role) || (!empty($permissions) && in_array('Gallery', $permissions))): ?>
                    <li
                        ...
                        <?php elseif(request()->is('admin/gallery/edit/*')): ?> menu-open <?php endif; ?>">
                        <a href="#"
                            class="nav-link
                            ...
                            <?php elseif(request()->is('admin/gallery/edit/*')): ?> active <?php endif; ?>">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.gcategory') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                                    <?php if(request()->path() == 'admin/gallery/gallery-category'): ?> active 
                                    <?php elseif(request()->path() == 'admin/gallery/gallery-category/add'): ?> active
                                    <?php elseif(request()->is('admin/gallery/gallery-category/edit/*')): ?> active <?php endif; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p><?php echo e(__('Category')); ?></p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.gallery.index') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                                    <?php if(request()->path() == 'admin/gallery'): ?> active 
                ...
                <?php if(empty($admin->role) || (!empty($permissions) && in_array('Job', $permissions))): ?>
                    <li
                        ...
                        <?php elseif(request()->is('admin/job/edit/*')): ?> menu-open <?php endif; ?>">
                        <a href="#"
                            class="nav-link
                        ...
                        <?php elseif(request()->is('admin/job/edit/*')): ?> active <?php endif; ?>">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.jcategory') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                            <?php if(request()->path() == 'admin/job/job-category'): ?> active
                            <?php elseif(request()->path() == 'admin/job/job-category/add'): ?> active
                            <?php elseif(request()->is('admin/job/job-category/edit/*')): ?> active <?php endif; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p><?php echo e(__('Job Categories')); ?></p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.job') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                            <?php if(request()->path() == 'admin/job'): ?> active
                            <?php elseif(request()->path() == 'admin/job/add'): ?> active
                            <?php elseif(request()->is('admin/job/edit/*')): ?> active <?php endif; ?>">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.applicant.pending')); ?>"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.applicant.interviewing')); ?>"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.applicant.selected')); ?>"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.applicant.rejected')); ?>"
                                    class="nav-link
                ...
                <?php if(empty($admin->role) || (!empty($permissions) && in_array('Blog', $permissions))): ?>
                    <li
                        ...
                        <?php elseif(request()->is('admin/archive/edit/*')): ?> menu-open <?php endif; ?>">
                        <a href="#"
                            class="nav-link
                            ...
                            <?php elseif(request()->is('admin/archive/edit/*')): ?> active <?php endif; ?>">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.bcategory') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                                    <?php if(request()->path() == 'admin/blog/blog-category'): ?> active 
                                    <?php elseif(request()->path() == 'admin/blog/blog-category/add'): ?> active
                                    <?php elseif(request()->is('admin/blog/blog-category/edit/*')): ?> active <?php endif; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Category</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.archive') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.blog') . '?language=' . $lang_code); ?>"
                                    class="nav-link
                                    <?php if(request()->path() == 'admin/blog'): ?> active 
                                    <?php elseif(request()->path() == 'admin/blog/add'): ?> active
                                    <?php elseif(request()->is('admin/blog/edit/*')): ?> active <?php endif; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Blog</p>
                                </a>
                            </li>
                ...
                <?php if(empty($admin->role) || (!empty($permissions) && in_array('Role Management', $permissions))): ?>
                    <li
                        ...
                        <?php elseif(request()->is('admin/role/*/permissions/manage')): ?> menu-open <?php endif; ?>
                        ">
                        <a href="#"
                            class="nav-link
                ...
                <?php if(empty($admin->role) || (!empty($permissions) && in_array('Subscribers', $permissions))): ?>
                    <li
                        ...
                        <?php elseif(request()->path() == 'admin/mailsubscriber'): ?> menu-open <?php endif; ?>
                            ">
                        <a href="#"
                            class="nav-link
                        <?php if(request()->path() == 'admin/subscriber'): ?> active 
                        <?php elseif(request()->path() == 'admin/subscriber/add'): ?> active
                        <?php elseif(request()->path() == 'admin/mailsubscriber'): ?> active <?php endif; ?>
                        ">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.newsletter')); ?>"
                                    class="nav-link
                            <?php if(request()->path() == 'admin/subscriber'): ?> active 
                            <?php elseif(request()->path() == 'admin/subscriber/add'): ?> active <?php endif; ?>
                            ">
                                    <i class="far fa-circle nav-icon"></i>
                ...
                <?php if(empty($admin->role) || (!empty($permissions) && in_array('Language', $permissions))): ?>
                    <li class="nav-item">
                        <a href="<?php echo e(route('admin.language-manage')); ?>"
                            class="nav-link
                            ...
                            <?php elseif(request()->is('admin/language/*/edit/keyword')): ?> active <?php endif; ?>">
...
<?php /**PATH C:\laragon\www\eshbhs\resources\views/admin/partials/side-navbar.blade.php ENDPATH**/ ?>