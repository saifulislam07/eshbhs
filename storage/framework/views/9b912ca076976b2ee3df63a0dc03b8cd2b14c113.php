                                ...
                                <tbody>
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <img class="w-80" src="<?php echo e(asset('profilepic/' . $user->profilepic)); ?>"
                                                    alt="">
                                            </td>
                                            ...
                                            <td>
                                                <form id="statusForm<?php echo e($user->id); ?>" class="d-inline-block"
                                                    action="<?php echo e(route('admin.front_user.status_update')); ?>" method="post">
                                                    <?php echo csrf_field(); ?>
                                                    <input type="hidden" name="user_id" value="<?php echo e($user->id); ?>">
                                                    <select
                                                        class="form-control form-control-sm
                                        <?php if($user->email_verified == '0'): ?> bg-warning
                                        ...
                                        "
                                                        ...
                                                        <option value="0"
                                                            <?php echo e($user->email_verified == '0' ? 'selected' : ''); ?>>Unverify
                                                        </option>
                                                        <option value="Yes"
                                                            <?php echo e($user->email_verified == 'Yes' ? 'selected' : ''); ?>>Verify
                                                        </option>
                                                    </select>
                                                </form>
                                            </td>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\eshbhs\resources\views/admin/fuser/index.blade.php ENDPATH**/ ?>