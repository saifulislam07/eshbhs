<footer class="no-print footer-area footer-area-two"
    style="background-image: url(<?php echo e(asset('assets/front/img/' . $setting->footer_bg_image)); ?>);">
                        ...
                        <div class="footer-list">
                            <ul>
                                <?php $__currentLoopData = $flinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a href="<?php echo e($item->url); ?>"><i
                                                class="fal fa-angle-right"></i><?php echo e($item->name); ?></a></li>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="widget-item-3 mt-30">
                        ...
                        <div class="features-sub">
                            <p><?php echo e(__('Many aspects of computing and technology and the term is more recognizable than before.')); ?>
...
<?php /**PATH E:\officeserver\htdocs\eshbhs\resources\views/front/partials/footer.blade.php ENDPATH**/ ?>