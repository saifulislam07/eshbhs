            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="info-box">
                        <span class="info-box-icon bg-info"><i class="far fa-star"></i></span>
                        <?php
                            $porder = App\Models\Order::where('order_status', '0')
                                ->orderBy('id', 'DESC')
                                ->get();
                        ?>
                        <div class="info-box-content">
                ...
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="info-box">
                        <span class="info-box-icon bg-info"><i class="far fa-star"></i></span>
                        <?php
                            $applicants = App\Models\JobApplication::where('status', '0')
                                ->orderBy('id', 'DESC')
                                ->get();
                        ?>
                        <div class="info-box-content">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-info btn-sm"
                                                    href="<?php echo e(route('admin.quote.details', $quote->id)); ?>"><i
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\officeserver\htdocs\eshbhs\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>