...
@section('content')
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if ($order->payment_status == 0)
                                                                    <span
                                                                        class="badge badge-info">{{ __('Pending') }}</span>
                                                            ...
                                                            <td>
                                                                <button type="button"
                                                                    data-href="{{ route('user.order.details', $order->id) }}"
                                                                    class="btn btn-primary view_order_details btn-sm"
                                                                    data-toggle="modal"
    ...
    <div class="modal fade" id="view_order_details_modal" tabindex="-1" role="dialog"
