<footer class="no-print footer-area footer-area-two"
    style="background-image: url({{ asset('assets/front/img/' . $setting->footer_bg_image) }});">
                            ...
                            <ul>
                                @foreach ($flinks as $item)
                                    <li><a href="{{ $item->url }}"><i
                                                class="fal fa-angle-right"></i>{{ $item->name }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div> <!-- widget item 2 -->
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="widget-item-3 mt-30">
                        ...
                        <div class="features-sub">
                            <p>{{ __('Many aspects of computing and technology and the term is more recognizable than before.') }}
                            </p>
