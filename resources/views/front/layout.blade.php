...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('assets/front/') }}/css/dynamic-css.php?color={{ $commonsetting->base_color }}&gcolor1={{ $commonsetting->gcolor1 }}&gcolor2={{ $commonsetting->gcolor2 }}&gcolor3={{ $commonsetting->gcolor3 }}">
...
<body class=" @if ($commonsetting->theme_version == 'theme7' || $commonsetting->theme_version == 'theme8') gradint_body @endif">
    ...
    <div class="quick_call_area no-print">
        ...
        @if ($visibility->is_whatsapp == 1)
            <a class="wp" href="https://api.whatsapp.com/send?phone={{ $setting->whatsapp }}" target="_blank"><i
