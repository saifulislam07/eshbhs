    ...
    <div class="sidebar pt-0 mt-0">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.registerMembers2023') }}"
                        class="nav-link @if (request()->path() == 'admin/registerMembers2023') active @endif">
                ...
                @if (empty($admin->role) || (!empty($permissions) && in_array('Website Customization', $permissions)))
                    <li
                        ...
                        @elseif(request()->is('admin/flink/edit/*')) menu-open @endif">
                        <a href="#"
                            class="nav-link
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @elseif(request()->path() == 'admin/sitemap')  menu-open @endif">
                                <a href="#"
                                    class="nav-link 
                                ...
                                <ul class="nav nav-treeview ">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('admin.sitemap.index') . '?language=' . $lang_code }}"
                                            class="nav-link 
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.pagevisibility') }}"
                                    ...
                                    @elseif(request()->path() == 'admin/page-visibility/theme6') active 
                                    @elseif(request()->path() == 'admin/page-visibility/innerpage') active 
                                    @elseif(request()->path() == 'admin/page-visibility/others') active @endif">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.permalinks.index') }}"
                                    class="nav-link
                                    @if (request()->path() == 'admin/permalinks') active @endif">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>{{ __('Permalink') }}</p>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                @elseif(request()->path() == 'admin/flink/add') active
                                @elseif(request()->is('admin/flink/edit/*')) active @endif
                                ">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>{{ __('Footer Link') }}</p>
                                </a>
                ...
                @if (empty($admin->role) || (!empty($permissions) && in_array('General Settings', $permissions)))
                    <li
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.theme_version') }}"
                                    class="nav-link
                            @if (request()->path() == 'admin/theme-version') active @endif">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            @elseif(request()->path() == 'admin/mail-admin')  menu-open @endif">
                                <a href="#"
                                    class="nav-link 
                                @if (request()->path() == 'admin/email-config') active 
                                @elseif(request()->path() == 'admin/mail-admin')  active @endif">
                                    <i class="far fa-circle nav-icon"></i>
                ...
                @if (empty($admin->role) || (!empty($permissions) && in_array('Ecommerce', $permissions)))
                    <li
                        ...
                        @elseif(request()->path() == 'admin/currency/add') menu-open @endif">
                        <a href="#"
                            class="nav-link
                        ...
                        @elseif(request()->path() == 'admin/currency/add') active @endif">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                ...
                                @elseif(request()->is('admin/payment/gateway/edit/*')) active @endif">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.shipping.index') . '?language=' . $lang_code }}"
                                    class="nav-link
                                @if (request()->path() == 'admin/shipping/methods') active
                                @elseif(request()->is('admin/shipping/method/edit/*')) active @endif">
                                    <i class="far fa-circle nav-icon"></i>
                    ...
                    <li
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin.product.category') . '?language=' . $lang_code }}"
                                    class="nav-link
                                @if (request()->path() == 'admin/product/product-category') active
                                @elseif(request()->path() == 'admin/product/product-category/add') active
                                @elseif(request()->is('admin/product/product-category/edit/*')) active @endif">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>{{ __('Product Categories') }}</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.product') . '?language=' . $lang_code }}"
                                    class="nav-link
                                @if (request()->path() == 'admin/product') active
                                @elseif(request()->path() == 'admin/product/add') active
                ...
                @if (empty($admin->role) || (!empty($permissions) && in_array('Home', $permissions)))
                    <li
                        ...
                        @elseif(request()->is('admin/testimonial/edit/*')) menu-open @endif
                        ">
                        <a href="#"
                            class="nav-link
                        ...
                        <ul class="nav nav-treeview">
                            <li
                                ...
                                @elseif(request()->path() == 'admin/hero/herovideo') menu-open
                                @elseif(request()->path() == 'admin/slider/add') menu-open
                                @elseif(request()->is('admin/slider/edit/*')) menu-open @endif
                                ">
                                <a href="#"
                                    class="nav-link
                                @if (request()->path() == 'admin/hero/static') active
                                ...
                                <ul
                                    ...
                                    ">
                                    <li class="nav-item">
                                        <a href="{{ route('admin.hero.index') . '?language=' . $lang_code }}"
                                            class="nav-link
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('admin.slider') . '?language=' . $lang_code }}"
                                            class="nav-link
                            ...
                            <li
                                class="nav-item 
                                    @if (request()->path() == 'admin/ecommerce/slider') menu-open
                                        ...
                                        @elseif(request()->path() == 'admin/ecommerce/banner') menu-open
                                        @elseif(request()->path() == 'admin/ecommerce/banner/add') menu-open
                                        @elseif(request()->is('admin/ecommerce/banner/edit/*')) menu-open @endif
                                ">
                                <a href="#"
                                    class="nav-link
                                        ...
                                        @elseif(request()->path() == 'admin/ecommerce/banner') active
                                        @elseif(request()->path() == 'admin/ecommerce/banner/add') active
                                        @elseif(request()->is('admin/ecommerce/banner/edit/*')) active @endif
                                    ">
                                    <i class="far fa-circle nav-icon"></i>
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ route('admin.ecommerce.slider') . '?language=' . $lang_code }}"
                                            class="nav-link
                                            @if (request()->path() == 'admin/ecommerce/slider') active
                                            @elseif(request()->path() == 'admin/ecommerce/slider/add') active
                                            @elseif(request()->is('admin/ecommerce/slider/edit/*')) active @endif
                                        ">
                                            <i class="far fa-dot-circle nav-icon"></i>
                                            <p>{{ __('Slider') }}</p>
                                        </a>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('admin.ecommerce.banner') . '?language=' . $lang_code }}"
                                            class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.about_section') . '?language=' . $lang_code }}"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.w_w_a') . '?language=' . $lang_code }}"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.feature.index') . '?language=' . $lang_code }}"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.intro_video') . '?language=' . $lang_code }}"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.why_chooseus') . '?language=' . $lang_code }}"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.service_section') . '?language=' . $lang_code }}"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.project_section') . '?language=' . $lang_code }}"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.testimonial') . '?language=' . $lang_code }}"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.team') . '?language=' . $lang_code }}"
                                    class="nav-link
                            @if (request()->path() == 'admin/team') active
                            @elseif(request()->path() == 'admin/team/add') active
                            @elseif(request()->is('admin/team/edit/*')) active @endif
                            ">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>{{ __('Team Section') }}</p>
                                </a>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.faq') . '?language=' . $lang_code }}"
                                    class="nav-link
                            @if (request()->path() == 'admin/faq') active
                            @elseif(request()->path() == 'admin/faq/add') active
                            @elseif(request()->is('admin/team/faq/*')) active @endif
                            ">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>{{ __('FAQ Section') }}</p>
                                </a>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.counter.index') . '?language=' . $lang_code }}"
                                    class="nav-link
                            @if (request()->path() == 'admin/counter') active 
                            @elseif(request()->path() == 'admin/counter/add') active
                            @elseif(request()->is('admin/counter/edit/*')) active @endif
                            ">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.meet_section') . '?language=' . $lang_code }}"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.contact_section') . '?language=' . $lang_code }}"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.blog_section') . '?language=' . $lang_code }}"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.client.index') . '?language=' . $lang_code }}"
                                    class="nav-link
                            @if (request()->path() == 'admin/client') active 
                            @elseif(request()->path() == 'admin/client/add') active
                            @elseif(request()->is('admin/client/edit/*')) active @endif
                            ">
                                    <i class="far fa-circle nav-icon"></i>
                ...
                @if (empty($admin->role) || (!empty($permissions) && in_array('Inner Page', $permissions)))
                    <li
                        ...
                        @elseif(request()->is('admin/portfolio/edit/*')) menu-open @endif">
                        <a href="#"
                            class="nav-link
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.history.index') . '?language=' . $lang_code }}"
                                    class="nav-link
                                    @if (request()->path() == 'admin/history') active 
                                    @elseif(request()->path() == 'admin/history/add') active
                                    @elseif(request()->is('admin/history/edit/*')) active @endif">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.service') . '?language=' . $lang_code }}"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.contact_page') . '?language=' . $lang_code }}"
                                    class="nav-link
                                    @if (request()->path() == 'admin/contact-page') active @endif">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>
                                        {{ __('Contact') }}
                                    </p>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.portfolio.index') . '?language=' . $lang_code }}"
                                    class="nav-link
                ...
                @if (empty($admin->role) || (!empty($permissions) && in_array('Quote', $permissions)))
                    <li
                        ...
                        @elseif(request()->is('admin/quote/details/*')) menu-open @endif
                        ">
                        <a href="#"
                            class="nav-link @if (request()->path() == 'admin/all/quote') active 
                            ...
                            @elseif(request()->is('admin/quote/details/*')) active @endif">
                ...
                @if (empty($admin->role) || (!empty($permissions) && in_array('Gallery', $permissions)))
                    <li
                        ...
                        @elseif(request()->is('admin/gallery/edit/*')) menu-open @endif">
                        <a href="#"
                            class="nav-link
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin.gcategory') . '?language=' . $lang_code }}"
                                    class="nav-link
                                    @if (request()->path() == 'admin/gallery/gallery-category') active 
                                    @elseif(request()->path() == 'admin/gallery/gallery-category/add') active
                                    @elseif(request()->is('admin/gallery/gallery-category/edit/*')) active @endif">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>{{ __('Category') }}</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.gallery.index') . '?language=' . $lang_code }}"
                                    class="nav-link
                                    @if (request()->path() == 'admin/gallery') active 
                ...
                @if (empty($admin->role) || (!empty($permissions) && in_array('Job', $permissions)))
                    <li
                        ...
                        @elseif(request()->is('admin/job/edit/*')) menu-open @endif">
                        <a href="#"
                            class="nav-link
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin.jcategory') . '?language=' . $lang_code }}"
                                    class="nav-link
                            @if (request()->path() == 'admin/job/job-category') active
                            @elseif(request()->path() == 'admin/job/job-category/add') active
                            @elseif(request()->is('admin/job/job-category/edit/*')) active @endif">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>{{ __('Job Categories') }}</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.job') . '?language=' . $lang_code }}"
                                    class="nav-link
                            @if (request()->path() == 'admin/job') active
                            @elseif(request()->path() == 'admin/job/add') active
                            @elseif(request()->is('admin/job/edit/*')) active @endif">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.applicant.pending') }}"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.applicant.interviewing') }}"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.applicant.selected') }}"
                                    class="nav-link
                ...
                @if (empty($admin->role) || (!empty($permissions) && in_array('Blog', $permissions)))
                    <li
                        ...
                        @elseif(request()->is('admin/archive/edit/*')) menu-open @endif">
                        <a href="#"
                            class="nav-link
                            ...
                            @elseif(request()->is('admin/archive/edit/*')) active @endif">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin.bcategory') . '?language=' . $lang_code }}"
                                    class="nav-link
                                    @if (request()->path() == 'admin/blog/blog-category') active 
                                    @elseif(request()->path() == 'admin/blog/blog-category/add') active
                                    @elseif(request()->is('admin/blog/blog-category/edit/*')) active @endif">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Category</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.archive') . '?language=' . $lang_code }}"
                                    class="nav-link
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.blog') . '?language=' . $lang_code }}"
                                    class="nav-link
                                    @if (request()->path() == 'admin/blog') active 
                                    @elseif(request()->path() == 'admin/blog/add') active
                ...
                @if (empty($admin->role) || (!empty($permissions) && in_array('Role Management', $permissions)))
                    <li
                        ...
                        @elseif(request()->is('admin/role/*/permissions/manage')) menu-open @endif
                        ">
                        <a href="#"
                            class="nav-link
                ...
                @if (empty($admin->role) || (!empty($permissions) && in_array('Subscribers', $permissions)))
                    <li
                        ...
                        @elseif(request()->path() == 'admin/mailsubscriber') menu-open @endif
                            ">
                        <a href="#"
                            class="nav-link
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin.newsletter') }}"
                                    class="nav-link
                            @if (request()->path() == 'admin/subscriber') active 
                            @elseif(request()->path() == 'admin/subscriber/add') active @endif
                            ">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>{{ __('Subscribers') }}</p>
                                </a>
