                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('admin.gallery.index') . '?language=' . $currentLang->code }}"
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ route('admin.gallery.store') }}" method="POST"
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 control-label">{{ __('Language') }}<span
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <p class="help-block text-info">
                                            {{ __('Upload 730X455 (Pixel) Size image for best quality.
