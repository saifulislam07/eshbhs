            ...
            <a href="<?php echo e(route('front.cart')); ?>" class="cart carticon">
                <div class="icon">
                    <i class="fal fa-shopping-cart" id="view_cart_ajax"
                        data-target="<?php echo e(route('header.cart.load')); ?>"></i>
                    <?php
                        $countitem = 0;
                        if (Session::has('cart')) {
                    ...
                    ?>
                    <span class="cart-quantity cart-count" data-target="<?php echo e(route('cart.qty.get')); ?>"
                        id="cart-count"><?php echo e(count($cart)); ?></span>
                </div>
...
<?php /**PATH E:\officeserver\htdocs\eshbhs\core\resources\views/front/partials/menu/nav-item.blade.php ENDPATH**/ ?>