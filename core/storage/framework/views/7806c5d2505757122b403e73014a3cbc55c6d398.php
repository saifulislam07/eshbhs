            ...
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title mt-1"><?php echo e(__('Add Gallery Category')); ?></h3>
                                <div class="card-tools">
                                    <a href="<?php echo e(route('admin.gcategory'). '?language=' . $currentLang->code); ?>" class="btn btn-primary btn-sm">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="<?php echo e(route('admin.gcategory.store')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\officeserver\htdocs\eshbhs\core\resources\views/admin/gallery/gallery-category/add.blade.php ENDPATH**/ ?>