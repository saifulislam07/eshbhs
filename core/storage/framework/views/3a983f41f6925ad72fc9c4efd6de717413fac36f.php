                        ...
                        <div class="sign-form">
                            ...
                            <form class="" action="<?php echo e(route('user.register.submit')); ?>" method="POST">
                                ...
                                <div class="input-group">
                                    <input class="form-control" type="text" value="<?php echo e(old('name')); ?>" name="name" placeholder="<?php echo e(__('Enter Full Name')); ?>">
                                ...
                                <div class="input-group">
                                    <input class="form-control" type="text" value="<?php echo e(old('username')); ?>" name="username" placeholder="<?php echo e(__('Enter Username')); ?>">
                                ...
                                <div class="input-group">
                                    <input class="form-control" type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="<?php echo e(__('Enter Email')); ?>">
...
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\officeserver\htdocs\eshbhs\core\resources\views/user/register.blade.php ENDPATH**/ ?>